/*
 AnimalLJS.java					Author: AMH, Lucia Josephine Scalies
 Creates an AnimalLJS object. AnimalLJS objects are able to be drawn in a 
...
public class AnimalLJS
{
	...
	protected int stepsTaken; //the steps the AnimalLJS object has taken
	
	//Constructor initializes instance data and creates an AnimalLJS object
	public AnimalLJS (int upperX, int upperY, int maxX, int maxY, int pause)
	{
		x = upperX;
		y = upperY;
		winX = maxX;
	...
	//Draws this AnimalLJS in the specified graphics context.
	...
	/*
	  Moves the AnimalLJS object up, down, left, or right randomly, a unit equal
	...
	*/
	...
	/*
	  ...
	  false
	*/
	public boolean collides(AnimalLJS fauna)
	{
	...
	*/
	public double getDistance(AnimalLJS fauna)
	{
		//determines the radius of each circle
		double radius = (double)diameter/2;
		double faunaRadius = (double)fauna.getDiameter()/2;
	...
	*/
	public void flee(AnimalLJS fauna, double power)
	{
		int radius = (int)((double)diameter/2);
		if(energy > 0)
		{
